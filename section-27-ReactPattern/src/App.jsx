      ...
      <section>
        ...
        <Accordion className='accordion'>
          <Accordion.Item id='experience' className='accordion-item'>
            <Accordion.Title className='accordion-item-title'>We got 20 years of experienced</Accordion.Title>
            <Accordion.Content className='accordion-item-content'>
              <article>
                <p>You can&pos;t go wrong with us.</p>
                <p>We are in the business of planning highly individualized trips for more than 20 years.</p>
              </article>
            </Accordion.Content>
          </Accordion.Item>
